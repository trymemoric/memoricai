...
|---|---|---|---|---|---|
| Single-hop | **81.3%** | 67.1% | 65.7% | 61.7% | — |
| Temporal | **71.7%** | 55.5% | 58.1% | 49.3% | — |
| Multi-hop | **52.5%** | 51.2% | 47.2% | 41.4% | — |
| Open-domain | 51.0% | 72.9% | 75.7% | 76.6% | — |
...
| `MEMORICAI_CONNECTOR_ALLOWED_ORIGINS` | — | Optional comma-separated exact origins allowed to reach private-network S3-compatible endpoints |
...
| `MEMORICAI_LLM_API_KEY` | — | Chat auth; fallback `OPENAI_API_KEY` |
...
| `MEMORICAI_EMBEDDING_API_KEY` | — | Embeddings auth; fallback `OPENAI_API_KEY` |
...
| Variable | Default | Purpose |
|---|---|---|
| `MEMORICAI_<PROVIDER>_CLIENT_ID` / `_CLIENT_SECRET` | — | OAuth app credentials per provider, e.g. `MEMORICAI_GOOGLE_DRIVE_CLIENT_ID` |
| `MEMORICAI_GITHUB_WEBHOOK_SECRET` | — | Enables GitHub push/delete webhooks (HMAC-SHA256 verified); unset → GitHub falls back to cron polling |
